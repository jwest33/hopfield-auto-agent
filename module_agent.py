...
class Agent:
    ...
    def step(self):
        ...
        # Movement or rest
        if act != "REST":
            # Moving between cells expends energy
            ...
            # Double recovery at home
            if curr_cell == "home":
                recovery *= 2
            self.energy = min(MAX_E, self.energy + recovery)

        # Metabolism: update hunger and pain, but no energy drain outside movement
